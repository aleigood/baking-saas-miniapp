  ...
  <view class="card-full-bleed-list">
    <view class="card-title-wrapper">
      <view class="title-with-tag">
        ...
        <span v-if="isDiscontinued" class="status-tag discontinued"
          >已停用</span
        >
      </view>
    </view>
      ...
      >
        <view class="version-item-content">
          <view class="version-item-wrapper">
            ...
            <view class="version-item-header">
              <view class="header-left">
                ...
                <text class="version-tag"
                  >V{{ version.version
                  }}{{ version.notes ? ` ${version.notes}` : "" }}</text
                >
              </view>
            </view>
            ...
            <!-- 第二行：修改项摘要 -->
            <view
              v-if="parseChangeSummary(version.changeSummary).length > 0"
              class="version-item-body"
            >
              <view class="change-tags-list">
                <view
                  v-for="(item, idx) in parseChangeSummary(
    ...
    <AppButton v-if="canEdit" type="text-link" @click="$emit('create-version')"
      >+ 创建新版本</AppButton
    >
  </view>
</template>
