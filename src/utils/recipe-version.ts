import type { RecipeVersionChangeItem, RecipeVersionChangeSummary } from '@/types/api';
...
export const formatRecipeChangeSummary = (summary: RecipeVersionChangeSummary | null | undefined) => {
